...
const DarkThemeToggle = (): JSX.Element => {
  ...
  return (
    <>
      {darkTheme ? (
        <button
          className="set-light-btn btn btn-circle p-1 bg-neutral-200 fill-neutral-800"
          onClick={toggleTheme}
        >
        ...
        <button
          className="set-dark-btn btn btn-circle p-1 bg-neutral-900 fill-white"
          onClick={toggleTheme}
        >
          <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
            {/* Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc. */}
